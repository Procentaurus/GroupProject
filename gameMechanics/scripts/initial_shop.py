...
def get_initial_shop_for_player(num_reaction_cards, num_action_cards, player_type):
    reaction_card_ids = get_random_card_ids(ReactionCard, num_reaction_cards, player_type)
    action_card_ids = get_random_card_ids(ActionCard, num_action_cards, player_type)
